<template>
  <section class="data_section" ref="data_section">
    <el-row :gutter="10" class="order_list">
      <el-col :span="24">
        <toolbarss @onSearch="searchDialogShow=true"></toolbarss>
        <customertable-list
          :mydata="tableData"
          :totalRows="totalRows"
          @goWork="goWork"
...
<barchart></barchart>
      ...
      <view-dialog v-if="viewDialogShow" :isShow="viewDialogShow"  :mydata="viewData" @closeDialog="viewDialogShow=false" @viewSubmit="viewSubmit"></view-dialog>
...
export default {
  ...
  methods: {
    ...
    viewSubmit(rows){
      this.$set(this.tableData,this.rowIndex,rows);
    },
