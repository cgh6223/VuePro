...
import { getInviteList } from "../../../api/old/bidding.js";
export default {
  name: "bidding_invite_index",
  data() {
    return {
      pageShow: {
        page: 1,
  ...
  methods: {
    getList() {
      ...
      getInviteList(pa).then(res => {
        this.tableData = res.rows;
        this.pageTotal = res.total;
        this.lineData = res.totalRows;
      });
    },
    customerGetList(val) {
      this.pageShow = Object.assign({}, this.pageShow, val);
      console.log(JSON.stringify(this.pageShow));
      this.getList();
    }
  }
};
