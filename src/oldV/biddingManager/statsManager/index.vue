    ...
    export default {
        data(){
          return {
            ...
            chart_bar:null,
            data:{
                legendData: ['工程咨询','工程造价','招标代理','工程监理','全过程工程咨询'],
                seriesData:[
                    {value:this.randomData(), name:'工程咨询'},
                    {value:this.randomData(), name:'工程造价'},
                    {value:this.randomData(), name:'招标代理'},
                    {value:this.randomData(), name:'工程监理'},
                    {value:this.randomData(), name:'全过程工程咨询'}
                ]
            }
          }
        },
          ...
          drawpie(id, radius, centery) {
            ...
            this.chart.setOption({
                ...
                series: [{
                    ...
                    legend: {
                        show: true,
                        data: ['工程咨询', '工程造价', '招标代理','工程监理','全过程工程咨询']
                    }
            });
          },
          drawbar(id){
