<template>
  <el-form id="invmodelinfo">
    <div class="invoicMain">
      <div class="invoiceHeader">
        <ul class="headerLeft">
          <li>
            <el-image :src="imgresource"></el-image>
          </li>
        ...
        <ul class="headerRight">
          ...
          <li><label> 开票日期： </label><span>111111</span></li>
          <li>
      ...
      <div class="invoiceBody">
        <div class="userInfo">
          ...
          <ul>
            <li>
              <label style="width:200px;"> 名 称:</label
              ><span
                ><el-input
                  size="mini"
                  placeholder="请输入内容"
                  suffix-icon="el-icon-date"
                  style="width:150px;height:22px;padding:0px 0px;line-hight:22px;"
                >
                </el-input
              ></span>
            </li>
        ...
        <div>
          ...
          <div class="userInfo">
            ...
            <ul>
              ...
              <li><label>纳税人识别号：</label><span>11111</span></li>
              <li>
