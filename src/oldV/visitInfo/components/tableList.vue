    ...
    >
      <el-table-column type="expand">
        <template slot-scope="props">
          ...
          >
            <el-table-column prop="visitTime" fixed label="回访时间" sortable align="center"></el-table-column>
            <el-table-column prop="visitType" label="回访方式" align="center" ></el-table-column>
            <el-table-column prop="department" label="回访人部门" align="center"></el-table-column>
            <el-table-column prop="duty" label="回访人职务" align="center"></el-table-column>
            <el-table-column prop="userName" label="回访人姓名" align="center"></el-table-column>
            <el-table-column prop="phoneNum" label="回访人电话" align="center" ></el-table-column>
            <el-table-column prop="projectName" label="项目名称" align="center" ></el-table-column>
            <el-table-column prop="major" label="是否存在重大公关事件" align="center"></el-table-column>
            <el-table-column prop="techLevels" label="技术质量评价等级" align="center" ></el-table-column>
          </el-table>
        </template>
      </el-table-column>
...
import { getRowDetail } from "../../../../api/customer.js";
export default {
