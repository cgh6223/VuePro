  ...
  <div class="logContainer">
    <div class="table">
      ...
      <el-table
        ...
        <el-table-column prop="majorType;" label="专业工程分类" align="center"></el-table-column>
        ...
        <el-table-column prop="contactPerson" label="委托联系人" align="center">
          <template slot-scope="scope">
            <el-popover-template :table-object="{show:true,labelPropList:clientTemplate,
        ...
        <el-table-column prop="outcomeDocument;" label="成果文件" align="center">
          <template slot-scope="scope">
            <el-popover-template :p-object="{show:true,labelPropList:outcomeDocumentTemplate,
                                 data:scope.row.outcomeDocument}"></el-popover-template>
          </template>
        </el-table-column>
