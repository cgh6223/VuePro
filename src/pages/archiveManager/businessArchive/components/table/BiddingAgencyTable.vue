    ...
    <div class="table">
        ...
        <el-row>
          ...
          <el-col :span="20">
            <el-checkbox-group v-model="checkList">
              <el-checkbox label="1">公告截图</el-checkbox>
              <el-checkbox label="2">公示截图</el-checkbox>
              <el-checkbox label="3">中标通知书</el-checkbox>
              <el-checkbox label="4">评价意见函</el-checkbox>
              <el-checkbox label="5">成交合同</el-checkbox>
            </el-checkbox-group>
          </el-col>
        </el-row>
      </div>
      <div class="table">
        <el-table
          ...
          <el-table-column prop="startTime" label="开标时间" align="center"></el-table-column>
          <el-table-column prop="money" label="中标金额" align="center">
            <template slot-scope="scope">
              <el-popover-template title="6000000" :table-object="{show:true,labelPropList:moneyGroupTemplate,
                                 data:scope.row.money}"></el-popover-template>
            </template>
          </el-table-column>
          <el-table-column prop="issueTime" label="中标通知书发出时间" align="center"></el-table-column>
