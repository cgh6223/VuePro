  ...
  <div class="logContainer">
    <div class="table">
        ...
        <el-row>
          ...
          <el-col :span="20">
            <el-checkbox-group v-model="checkList">
              ...
              <el-checkbox label="2">定案表</el-checkbox>
              <el-checkbox label="3">鉴定意见书</el-checkbox>
              <el-checkbox label="4">补充鉴定</el-checkbox>
              <el-checkbox label="5">评价意见函</el-checkbox>
            </el-checkbox-group>
          </el-col>
        </el-row>
      </div>
      <el-table
        ...
        <el-table-column prop="outcomeDocument" label="成果文件" align="center">
          <template slot-scope="scope">
            <el-popover-template :p-object="{show:true,labelPropList:outcomeDocumentTemplate,
                                 data:scope.row.outcomeDocument[0]}"></el-popover-template>
          </template>
        </el-table-column>
        <el-table-column prop="compileMoney" label="编制金额" align="center"></el-table-column>
        <el-table-column prop="examineMoney" label="审核金额" align="center">
          <template slot-scope="scope">
            <el-popover-template :p-object="{show:true,labelPropList:examineMoneyTemplate,
                                 data:scope.row.examineMoney[0]}"></el-popover-template>
          </template>
        </el-table-column>
