    ...
    <div class="column">
      <div class="card-main">
        ...
        <el-table :key="tableKey"
          ...
          <el-table-column prop="signdateTime" label="协议签订时间" align="center"></el-table-column>
          ...
          <el-table-column label="操作" align="center" width="250px" fixed="right">
            <template slot-scope="scope">
              <template v-if="scope.row.allstatuscode!=='7'">
                ...
                <submit-button v-if="scope.row.allstatuecode==='0'" title="提交审核" @click="submitReport(scope.row)"></submit-button>
  ...
  export default {
    ...
    methods: {
      ...
      async submitReport(formData) {
        this.ddform('v_2020_htgl_fyw_bzxytj', {
