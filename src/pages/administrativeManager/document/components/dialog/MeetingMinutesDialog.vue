  ...
  <div>
    <el-dialog :title="title" :visible.sync="dialogVisible" width="30%" @close="dialogClose()">
      <el-form :model="form" ref="formRef" :rules="formRules" label-width="120px">
        ...
        <el-form-item label="会议纪要" prop="userName">
          <upload-button></upload-button>
        </el-form-item>
        <el-form-item label="内容摘要" prop="userName">
          <el-textarea-template></el-textarea-template>
        </el-form-item>
        <el-form-item label="会议主办单位" prop="userName">
          <query-input></query-input>
        </el-form-item>
        <el-form-item label="参会签到表" prop="userName">
          <upload-button></upload-button>
        </el-form-item>
        <el-form-item label="缺勤人员" prop="userName">
        ...
        <el-form-item label="会议相关图片或影音" prop="userName">
          <upload-button></upload-button>
        </el-form-item>
      </el-form>
