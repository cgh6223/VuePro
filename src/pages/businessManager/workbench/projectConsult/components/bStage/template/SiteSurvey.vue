<template>
	<div class="b-main">
		...
		<div class="dialog">
			...
			<add-site-dialog title="修改" width="30%" data="data" ref="reviceSiteRef" @getFormData="networkUpData"></add-site-dialog>
		</div>
	</div>
</template>
<script>
	// import __ from '__' // __是需要手动引入的文件
	import AddSiteDialog from "../dialog/AddSiteDialog.vue"
