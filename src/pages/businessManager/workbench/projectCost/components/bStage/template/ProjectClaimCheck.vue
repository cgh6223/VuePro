<template>
  <div class="body">
    <div class="button">
      <head-right-button title="新增索赔" @click="$refs.addRef.openDialog()"></head-right-button>
    </div>
    <div class="table">
      <el-table ref="tableRef"
        ...
        <el-table-column prop="changeWorkAttchFile" label="索赔确认材料审核扫描件" align="center">
          <template slot-scope="scope">
            <upload-button v-model="scope.row.changeWorkAttchFile"
                           module-type="xm"
                           file-name="索赔确认材料审核扫描件"
        ...
        <el-table-column label="操作" align="center" width="250px">
          <template slot-scope="scope">
            ...
            <el-button type="text" size="mini" @click="$refs.scanRef.openDialog(scope.row)">扫描件上传</el-button>
    ...
    <div class="dialog">
      <add-dialog ref="addRef" title="新增签证材料" width="30%" @getFormData="networkAddData"></add-dialog>
      <add-dialog ref="updateRef" title="修改签证材料" width="30%" @getFormData="networkUpData"></add-dialog>
...
<script>
  ...
  import AddDialog from '../dialog/projectClaimCheck/AddDialog.vue'
  import ScanFileDialog from '../dialog/projectClaimCheck/ScanFileDialog.vue'
