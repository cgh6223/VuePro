<template>
	<div>
		...
		<com-document is-add-means code="TYPE-155"></com-document>
	</div>
</template>
<script>
			...
			headButtonClick(btn) {
				switch (btn) {
					case 1:
						...
						break;
          case 2:
            this.$refs.addOpRef.openDialog({payVisitDocName:'招标情况报告'});
            break;
          case 3:
            this.$refs.addOpRef.openDialog({payVisitDocName:'中标人与业主签订的合同'});
            break;
					case 4:
