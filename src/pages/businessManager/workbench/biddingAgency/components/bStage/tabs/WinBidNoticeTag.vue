<template>
  <div class="b-main">
    ...
    <div class="dialog">
      ...
      <perfect-bid-notice-dialog title="完善通知苏信息" width="30%" ref="perfectRef"
                                 @getFormData="networkUpData"></perfect-bid-notice-dialog>
    </div>
  </div>
</template>
<script>
    ...
    methods: {
      ...
      async submitExamine(data) {
        this.ddform('v_2020_ywgl_zbdl_tzssh', {
          ...
          fileList: [
            {title: '文件', file:await this.getfile(data.noticeFile)},
          ],
