<template>
	<div class="body">
		<div class="table">
			<el-table ref="tableRef" :data="items.dataList" style="width: 100%" align="center" height="7rem" highlight-current-row
			 :header-cell-style="{fontSize:'14px'}">
				...
				<el-table-column prop="projectTypeName" label="项目类型" align="center"></el-table-column>
				...
				<el-table-column prop="datajson" label="中标情况" align="center" width="100">
					<template slot-scope="scope">
						<com-popover data-type="obj" :data="scope.row.datajson" :label-prop="bidInfo"></com-popover>
					</template>
				</el-table-column>
				<el-table-column prop="projectOrgName" label="项目归属" align="center" width="100"></el-table-column>
		...
		<div class="pagination">
			<!--分页-->
			<pagination :pageTotal="items.total" @handleCurrentChange="handleCurrentChange" @handleSizeChange="handleSizeChange"></pagination>
		</div>
        ...
        outcomeDocumentTemplate: [
          ...
          },
          {
            ...
            prop: 'IncreaseOrDecreaseRate'
				...
				//中标情况
				bidInfo:[
					{label:'开标时间',prop:'begindateTime'},
					{label:'中标金额',prop:'projectSum'},
