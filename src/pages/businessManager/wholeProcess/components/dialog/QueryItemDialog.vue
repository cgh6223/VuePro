<template>
	<div>
		<el-dialog :title="title" :visible.sync="dialogVisible" :width="width" @close="dialogClose">
				...
				<el-row>
					<el-col :span="12">
						...
						<el-form-item label="专业工程分类" prop="">
							<el-select-template :data="projectType" v-model="form.projectType"></el-select-template>
						</el-form-item>
						<el-form-item label="工程咨询负责人" prop="">
							<el-select-template :data="itemManager"></el-select-template>
						</el-form-item>
						<el-form-item label="招标代理负责人" prop="">
							<el-select-template :data="itemManager"></el-select-template>
						</el-form-item>
						<el-form-item label="项目管理负责人" prop="">
							<el-select-template :data="itemManager"></el-select-template>
						</el-form-item>
					</el-col>
					<el-col :span="12">
			...
			<dialog-button reset-btn="true" okBtn="筛 选" @okBtn="submitForm" @cancelBtn="dialogClose"></dialog-button>
		</el-dialog>
	</div>
</template>
<script>
