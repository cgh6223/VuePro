  ...
  <div>
    ...
    <div style="height: 350px">
      <el-table :data="data" stripe :show-header="false">
        <el-table-column prop="projectJobName" min-width="75px" align="right"></el-table-column>
        <el-table-column prop="projectPersonName" min-width="100px" align="left"></el-table-column>
        <el-table-column prop="" min-width="75px" align="right">
          <template slot-scope="scope">
            <span v-if="scope.row.jobDesc!==''">备注</span>
          </template>
        </el-table-column>
        <el-table-column prop="jobDesc" min-width="100px" align="left"></el-table-column>
      ...
      <el-dialog :visible.sync="dialogVisible" :append-to-body="true" width="300px" @close="dialogClose">
        <el-form :model="form" ref="formRef" :rules="formRules" label-width="75px">
          <el-form-item label="职务名称" prop="workItemContext">
            <rea-select v-model="form.projectJobKeyid" :data="typeList" @getObject="item=>{
          ...
          <el-form-item v-if="isContent" :label="form.projectJobName==='其他人员'?'工作备注':'专业备注'" prop="workItemContext">
