...
for (let i = 0; i < count; i++) {
    List.push(Mock.mock({
        id: Mock.Random.guid(),
        htNo: 'HDZX-2020-' + i.toString().padStart(3, '0'),
        sortnum: i + 1,
        projectNo:'HDZX-2020-' + i.toString().padStart(3, '0')+'-'+Mock.Random.integer(1,9).toString().padStart(3,'0'),
        projectName: Mock.Random.ctitle(4, 10),
        projectPrice: Mock.Random.float(1, 999999, 2, 2),
        projectStatus:Mock.Random.projectStatus()
    }))
}
